...
======== AI 返回的原始数据 ========
{
  ...
  "p": [
    ...
    "<span class=\"step\">Step 1</span> Briefly press/release Volume Up button",
    "<span class=\"step\">Step 2</span> Quickly tap Volume Down button",
    "<span class=\"step\>Step 3</span> Long-press Side Button until Apple logo surfaces (10-15 seconds)",
    ...
    "<span class=\"step\">Step 1</span> Download iOS Refixer installer from <a href=\"https://www.isumsoft.com\" rel=\"nofollow\">official site</a> and complete setup",
    "<span class=\"step\">Step 2</span> Initiate System Repair module from dashboard interface",
    "<span class=\"step\">Step 3</span> Select Data-Preserving Standard Mode for non-destructive repair",
    "<span class=\"step\">Step 4</span> Prepare device for recovery mode connection:",
...
'<span class="step">Step 1</span> Quickly press and release the Volume Up button.', 
'<span class="step">Step 2</span> Quickly press and release the Volume Down button.', 
'<span class="step">Step 3</span> Then, press and hold the Side Button until the <b>Apple logo</b> appears.', 
...
'<span class="step">Step 1</span> First, download and install iSumsoft iOS Refixer on your PC or 
Mac. Then, using a USB-C cable, securely connect your iPhone 15 Pro to the computer.', 
'<span class="step">Step 2</span> Launch iSumsoft iOS Refixer and select the "System Repair" option from the main interface.', 
...
'<span class="step">Step 3</span> Choose "Standard Mode," which allows you to fix the black screen issue without losing any data on your iPhone.', 
...
'<span class="step">Step 4</span> Follow the prompts 
...
======== AI 返回的原始数据 ========
{
  ...
  "p": [
    ...
    "<span class=\"step\">Step 1</span> Briefly press and release Volume Up (1 second)",
    "<span class=\"step\">Step 2</span> Immediately press and release Volume Down",
    "<span class=\"step\">Step 3</span> Hold Side Button until Apple logo appears (10+ seconds)",
    ...
    "<span class=\"step\">Step 1</span> Install iSumsoft iOS Refixer on Windows/Mac and connect iPhone 15 Pro via certified USB-C cable",
    "<span class=\"step\">Step 2</span> Launch software and select System Repair > Standard Mode for data-safe troubleshooting",
...
width=\"800\"/>",
    "<span class=\"step\">Step 3</span> Initiate recovery mode sequence: Volume Up > Volume Down > Side Button hold (until recovery screen appears)",
    ...
    "<span class=\"step\">Step 4</span> Download firmware package matching your iPhone 15 Pro model (automatic detection)",
    ...
    "<span class=\"step\">Step 5</span> Initiate repair process after firmware verification completes (15-25 minute duration)",
    ...
    "<span class=\"step\">Step 6</span> Monitor progress bar until system restoration completes",
    ...
    "<span class=\"step\">Step 7</span> Device automatically reboots with functional display post-repair",
...
p_array_1 = [
    ...
    "iSumsoft iOS Refixer",
    "<span class=\"step\">Step 1</span> First, download and install iSumsoft iOS Refixer on your PC or Mac. Then, using a USB-C cable, securely connect your iPhone 15 Pro to the computer.",
    "<span class=\"step\">Step 2</span> Launch iSumsoft iOS Refixer and select the \"System Repair\" option from the main interface.",
    "<span class=\"step\">Step 3</span> Choose \"Standard Mode,\" which allows you to fix the black screen issue without losing any data on your iPhone.",
    "<span class=\"step\">Step 4</span> Follow the prompts to connect your iPhone and enter recovery mode. To do this:",
    "1. Quickly press and release the Volume Up button.",
    "2. Quickly press and release the Volume Down button.",
    "3. Hold down the Side Button until the recovery mode screen (with the cable pointing to a computer) appears. Then, click \"Next.\"",
    "Step 5: The software will detect your iPhone and prompt you to download the appropriate firmware. Click \"Download\" to begin.",
...
p_array_2 = [
    ...
    "<span class=\"step\">Step 1</span> Quickly press/release Volume Up",
    "<span class=\"step\">Step 2</span> Quickly press/release Volume Down",
    "<span class=\"step\">Step 3</span> Hold Side Button until Apple logo appears",
    ...
    "iSumsoft iOS Refixer - Certified iOS Repair Solution",
    "<span class=\"step\">Step 1</span> Install software on computer and connect iPhone via USB-C",
    "<span class=\"step\">Step 2</span> Select System Repair > Standard Mode (data-safe option)",
    "<span class=\"step\">Step 3</span> Initiate recovery mode with button sequence:",
    "1. Quick Volume Up press/release",
    "2. Quick Volume Down press/release",
    "3. Hold Side Button until recovery screen appears",
    "<span class=\"step\">Step 4</span> Download firmware package through automated process",
    "<span class=\"step\">Step 5</span> Execute system repair with one-click interface",
